...
def test_random_forest_return_regressor_fits_and_predicts_continuous_return():
    dataset = MLDataset(
        samples=[
            create_sample(
...
def test_random_forest_return_regressor_trains_independent_models_by_horizon():
    dataset = MLDataset(
        samples=[
            create_sample(
                feature_timestamp=1_800_000_000_000,
...
def test_random_forest_return_regressor_uses_feature_names_consistently():
    dataset = MLDataset(
        samples=[
            create_sample(
                feature_timestamp=1_800_000_000_000,
...
def test_random_forest_return_regressor_rejects_inconsistent_training_feature_schema():
    dataset = MLDataset(
        samples=[
            create_sample(
                feature_timestamp=1_800_000_000_000,
...
def test_random_forest_return_regressor_rejects_incompatible_prediction_feature_schema():
    dataset = MLDataset(
        samples=[
            create_sample(
                feature_timestamp=1_800_000_000_000,
...
def test_random_forest_return_regressor_rejects_invalid_training_dataset(
    dataset,
):
    model = RandomForestReturnRegressor()
...
def test_random_forest_return_regressor_rejects_prediction_before_fit():
    model = RandomForestReturnRegressor()
...
def test_random_forest_return_regressor_rejects_unseen_horizon():
    dataset = MLDataset(
        samples=[
            create_sample(
                feature_timestamp=1_800_000_000_000,
...
def test_random_forest_return_regressor_rejects_invalid_horizon_type(
    horizon_minutes,
):
    dataset = MLDataset(
        samples=[
...
def test_random_forest_return_regressor_rejects_non_positive_horizon(
    horizon_minutes,
):
    dataset = MLDataset(
        samples=[
...
def test_random_forest_return_regressor_rejects_invalid_prediction_features(
    features,
):
    dataset = MLDataset(
        samples=[
...
def test_random_forest_return_regressor_rejects_non_positive_n_estimators(
    n_estimators,
):
    with pytest.raises(
        ValueError,
...
def test_random_forest_return_regressor_rejects_invalid_n_estimators_type(
    n_estimators,
):
    with pytest.raises(
        TypeError,
...
def test_random_forest_return_regressor_rejects_invalid_random_state(
    random_state,
):
    with pytest.raises(
        TypeError,
...
def test_random_forest_return_regressor_accepts_none_random_state():
    model = RandomForestReturnRegressor(
        random_state=None,
    )
